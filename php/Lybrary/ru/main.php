...
include_once "change.config.plist.php";
...
function boot_loader_select_repo($print = true)
{
    ...
    Чтобы выйти или запустить скрипт по изминению config.plist введите соответствующую букву в любом регистре:
    
        1) {$repo_arr[0]['name']}                                             C|c) Запустить изминения config.plist
        2) {$repo_arr[1]['name']}                                             Q|q) Выход из программы :(
